          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={trendData} margin={{ top: 0, right: 0, left: -20, bottom: 0 }}>
                <defs>
                  <linearGradient id="sentimentPositiveArea" x1="0" y1="0" x2="0" y2="1">
                  ...
                  <linearGradient id="sentimentNeutralArea" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor={CHART_COLORS.neutral} stopOpacity={0.3} />
                    <stop offset="95%" stopColor="#07DBFA" stopOpacity={0} />
                  </linearGradient>
                  <linearGradient id="sentimentNegativeArea" x1="0" y1="0" x2="0" y2="1">
                ...
                <Area
                  ...
                  fill="url(#sentimentPositiveArea)"
                  strokeWidth={2}
                  stackId="1"
                />
                <Area
                ...
                <Area
                  ...
                  fill="url(#sentimentNegativeArea)"
                  strokeWidth={2}
                  stackId="1"
                />
              </AreaChart>
