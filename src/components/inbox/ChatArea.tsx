...
const SpinnerIcon = () => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
    <path
      d="M8.05 2.45C8.05 2.17152 7.93938 1.90445 7.74246 1.70754C7.54555 1.51063 7.27848 1.4 7 1.4C6.72152 1.4 6.45445 1.51063 6.25754 1.70754C6.06063 1.90445 5.95 2.17152 5.95 2.45C5.95 2.72848 6.06063 2.99555 6.25754 3.19246C6.45445 3.38938 6.72152 3.5 7 3.5C7.27848 3.5 7.54555 3.38938 7.74246 3.19246C7.93938 2.99555 8.05 2.72848 8.05 2.45ZM8.05 11.55C8.05 11.2715 7.93938 11.0045 7.74246 10.8075C7.54555 10.6106 7.27848 10.5 7 10.5C6.72152 10.5 6.45445 10.6106 6.25754 10.8075C6.06063 11.0045 5.95 11.2715 5.95 11.55C5.95 11.8285 6.06063 12.0956 6.25754 12.2925C6.45445 12.4894 6.72152 12.6 7 12.6C7.27848 12.6 7.54555 12.4894 7.74246 12.2925C7.93938 12.0956 8.05 11.8285 8.05 11.55ZM2.45 8.05C2.72848 8.05 2.99555 7.93938 3.19246 7.74246C3.38938 7.54555 3.5 7.27848 3.5 7C3.5 6.72152 3.38938 6.45445 3.19246 6.25754C2.99555 6.06063 2.72848 5.95 2.45 5.95C2.17152 5.95 1.90445 6.06063 1.70754 6.25754C1.51063 6.45445 1.4 6.72152 1.4 7C1.4 7.27848 1.51063 7.54555 1.70754 7.74246C1.90445 7.93938 2.17152 8.05 2.45 8.05ZM12.6 7C12.6 6.72152 12.4894 6.45445 12.2925 6.25754C12.0956 6.06063 11.8285 5.95 11.55 5.95C11.2715 5.95 11.0045 6.06063 10.8075 6.25754C10.6106 6.45445 10.5 6.72152 10.5 7C10.5 7.27848 10.6106 7.54555 10.8075 7.74246C11.0045 7.93938 11.2715 8.05 11.55 8.05C11.8285 8.05 12.0956 7.93938 12.2925 7.74246C12.4894 7.54555 12.6 7.27848 12.6 7Z"
      fill="#AAACFF"
    />
  </svg>
);
...
const FormatIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path
      d="M2.64397 10.8115L2.3755 13.4068C2.31876 13.9553 2.76388 14.4255 3.31467 14.3989L5.86824 14.2756C6.09605 14.2646 6.3112 14.1676 6.47025 14.0042L11.574 8.75867C11.9184 8.40464 11.9134 7.83921 11.5627 7.49135L9.23693 5.18425C8.88441 4.83456 8.31536 4.8362 7.96486 5.18791L2.90185 10.2685C2.75623 10.4146 2.6652 10.6063 2.64397 10.8115Z"
      fill="#7A7D7D"
    />
    <path
      d="M13.9565 5.05184L11.6731 2.75092C11.3215 2.3966 10.7488 2.3959 10.3963 2.74936L9.64129 3.50645C9.29142 3.8573 9.2907 4.42488 9.63968 4.77661L11.9301 7.08506C12.2841 7.44185 12.8617 7.4398 13.2131 7.08049L13.961 6.31587C14.3052 5.96406 14.3031 5.40116 13.9565 5.05184Z"
      fill="#7A7D7D"
    />
    <path
      d="M3.79341 1.76128C3.89377 1.54624 4.19956 1.54624 4.29992 1.76128L4.84559 2.93049C4.87335 2.98997 4.92116 3.03779 4.98065 3.06555L6.14986 3.61122C6.3649 3.71158 6.3649 4.01736 6.14986 4.11772L4.98065 4.6634C4.92116 4.69116 4.87335 4.73897 4.84559 4.79845L4.29992 5.96766C4.19956 6.18271 3.89377 6.18271 3.79341 5.96766L3.24774 4.79845C3.21998 4.73897 3.17217 4.69116 3.11268 4.6634L1.94347 4.11772C1.72843 4.01736 1.72843 3.71158 1.94347 3.61122L3.11268 3.06555C3.17217 3.03779 3.21998 2.98997 3.24774 2.93049L3.79341 1.76128Z"
      fill="#7A7D7D"
    />
  </svg>
);
...
const FileIcon = () => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
    <path
      d="M4.2 1.4C3.42781 1.4 2.8 2.02781 2.8 2.8V11.2C2.8 11.9722 3.42781 12.6 4.2 12.6H9.8C10.5722 12.6 11.2 11.9722 11.2 11.2V4.9H8.4C8.01281 4.9 7.7 4.58719 7.7 4.2V1.4H4.2ZM8.4 1.4V4.2H11.2L8.4 1.4ZM4.2 7C4.2 6.81435 4.27375 6.6363 4.40502 6.50502C4.5363 6.37375 4.71435 6.3 4.9 6.3C5.08565 6.3 5.2637 6.37375 5.39497 6.50502C5.52625 6.6363 5.6 6.81435 5.6 7C5.6 7.18565 5.52625 7.3637 5.39497 7.49497C5.2637 7.62625 5.08565 7.7 4.9 7.7C4.71435 7.7 4.5363 7.62625 4.40502 7.49497C4.27375 7.3637 4.2 7.18565 4.2 7ZM7.525 7.7C7.64094 7.7 7.74812 7.75687 7.81375 7.85094L9.73875 10.6509C9.81312 10.7581 9.81969 10.8981 9.76062 11.0119C9.70156 11.1256 9.58125 11.2 9.45 11.2H7.525H6.65H5.6H4.55C4.42312 11.2 4.30719 11.1322 4.24594 11.0228C4.18469 10.9134 4.18469 10.7778 4.25031 10.6706L5.30031 8.92062C5.36375 8.81562 5.4775 8.75 5.6 8.75C5.7225 8.75 5.83625 8.81344 5.89969 8.92062L6.17969 9.38875L7.23625 7.85312C7.30187 7.75906 7.40906 7.70219 7.525 7.70219V7.7Z"
      fill="#B1B3B4"
    />
  </svg>
);
...
function ChannelIcon({ type }: { type: ChannelType }) {
  switch (type) {
    case "instagram":
      return (
        <InstagramIcon className="w-3 h-3 text-[#364153]" />
      );
    case "whatsapp":
      return (
    ...
    case "messenger":
      return (
        <MessengerIcon className="w-3 h-3 text-[#364153]" />
      );
    case "call":
      return <CallIcon className="w-3 h-3 text-[#364153]" />;
    case "email":
      return <EmailIcon className="w-3 h-3 text-[#364153]" />;
    case "webchat":
      return <WebChatIcon className="w-3 h-3 text-[#364153]" />;
    case "jira":
      return <JiraIcon className="w-3 h-3 text-[#364153]" />;
    default:
      return null;
  }
}
  ...
  return (
    <button className="flex items-center bg-[#f2f3f3] rounded-full p-1 border border-[#e3e3e4] gap-1">
      <div className="flex items-center -space-x-1">
        <div className="w-[18px] h-[18px] rounded-full bg-[#aaacff] border-2 border-white flex items-center justify-center text-[10px] font-bold text-[#202121]">
          P
        </div>
        <div className="w-[18px] h-[18px] rounded-full bg-[#e78f8f] border-2 border-white flex items-center justify-center text-[10px] font-bold text-[#202121]">
          N
        </div>
...
function HeaderAction({
  ...
  return (
    <div className="flex items-center gap-1 bg-white border border-[#e3e3e4] rounded-full px-2 py-1 shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.25)]">
      {icon}
      <span className="text-[12px] font-['Instrument_Sans'] font-semibold text-[#5e6060]">
        {label}
      </span>
    </div>
  );
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white min-w-0 relative">
      ...
      <div className="flex-1 overflow-y-auto p-6 bg-white">
        <div className="flex flex-col gap-6 px-4 min-w-full max-w-[70%] mx-auto">
          {messages.length > 0 ? (
            messages.map((msg) => {
              // 1. Incoming Message
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-1 text-[12px]">
                        <span className="font-bold text-[#7a7d7d] font-['Instrument_Sans']">
                          {msg.sender?.name}
                        </span>
                        <span className="text-[#7a7d7d] font-['Instrument_Sans']">
                          via
                        </span>
                        {msg.channel && (
                          <ChannelIcon type={msg.channel} />
                        )}
                      </div>
                      <div className="bg-[#f2f3f3] p-3 rounded-[16px] text-[12px] text-[#202121] font-['Instrument_Sans'] leading-relaxed">
                        ...
                        {msg.attachments &&
                          msg.attachments.map((att, idx) => (
                            <div
                              key={idx}
                              className="mt-2 bg-white rounded-full border border-[#e3e3e4] px-2 py-1 flex items-center justify-between w-full"
                            >
                              <div className="flex items-center gap-1">
                                <FileIcon />
                                <span className="font-semibold text-[#5e6060]">
                                  {att.name}
                                </span>
                              </div>
                              <span className="text-[#a0a3a4]">
                                {att.size}
                              </span>
                            </div>
                          ))}
              ...
              if (msg.type === "outgoing") {
                ...
                return (
                  <div
                    key={msg.id}
                    className="flex flex-col items-end self-end max-w-[70%] gap-1"
                  >
                    <span className="text-[12px] text-[#7a7d7d] mr-2">
                      You
                    </span>
              ...
              if (msg.type === "system") {
                return (
                  ...
                  >
                    <div className="flex items-center gap-1 text-[12px]">
                      <span className="font-bold text-[#a0a3a4]">
                        {msg.sender?.name}
                      </span>
                      <span className="text-[#a0a3a4]">
                        {msg.systemAction}
                      ...
                      {msg.systemBadge && (
                        <div
                          ...
                          style={{
                            backgroundColor:
                              msg.systemBadge.color,
                          }}
                        >
                          {/* Render icon based on string or generic fallback */}
                          {msg.systemBadge.icon === "tag" && (
                            <div className="w-3 h-3 text-[#8990DF]">
                              <TagIcon />
                            </div>
                          )}
                          <span className="text-[#404141]">
                            {msg.systemBadge.text}
                          </span>
                        </div>
                      )}
                    </div>
