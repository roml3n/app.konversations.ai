...
export function Workforce() {
  const [activeTab, setActiveTab] = useState<'real-time' | 'forecasting' | 'scheduling' | 'reports'>('real-time');

  return (
    <div className="flex h-full flex-col bg-white overflow-hidden">
      <WorkforceHeader />
      
      <div className="flex flex-col gap-6 px-[30px] py-6 overflow-auto">
        {/* Tab Navigation */}
        <WorkforceTabs activeTab={activeTab} onTabChange={setActiveTab} />
