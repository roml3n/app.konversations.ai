import svgPaths from "./svg-dgy6igqqfa";
...
function AddAgentsContainer() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0 w-full" data-name="Add Agents Container">
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#7a7d7d] text-[12px] w-full">Agents</p>
      <AddAgentsList />
    </div>
  );
}
...
function LabelsPopup() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[24px] grow items-start min-h-px min-w-px overflow-clip relative shrink-0 w-full" data-name="Labels Popup">
      <SearchBar />
      <AddAgentsContainer />
    </div>
  );
