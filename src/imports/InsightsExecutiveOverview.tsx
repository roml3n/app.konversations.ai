import svgPaths from "./svg-lagzm81q2y";
  ...
  return (
    <div className="relative shrink-0 size-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Frame 2">
          <mask fill="white" id="path-1-inside-1_2_5113">
            <path d={svgPaths.p1d1d6d00} />
          </mask>
          <path d={svgPaths.p1d1d6d00} fill="var(--fill-0, white)" fillOpacity="0.1" />
          <path d={svgPaths.p3a50b680} fill="var(--stroke-0, white)" fillOpacity="0.05" mask="url(#path-1-inside-1_2_5113)" />
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_2_5081)" id="chart-pie">
          <path d={svgPaths.p13864400} fill="var(--fill-0, #01B386)" id="Vector" />
        </g>
        <defs>
...
function Frame115() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow h-full items-start min-h-px min-w-px relative shrink-0">
      <Frame114 />
      <div className="basis-0 flex grow items-center justify-center min-h-px min-w-px relative shrink-0 w-full" style={{ "--transform-inner-width": "104.21875", "--transform-inner-height": "150.78125" } as React.CSSProperties}>
...
function ReactIconsBiSolidStar() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="react-icons/BiSolidStar">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_2_5007)" id="react-icons/BiSolidStar">
          <path d={svgPaths.p790f5f0} fill="var(--fill-0, #E2C148)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_2_5007">
