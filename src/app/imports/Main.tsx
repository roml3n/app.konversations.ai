import svgPaths from "./svg-iqh0hitjme";
...
function TableCellDateCreated() {
  return (
    <div className="box-border content-stretch flex gap-[14px] h-full items-center p-[8px] relative shrink-0 w-[277px]" data-name="table_cell / date_created">
      <p className="font-['Instrument_Sans:SemiBold',sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[#393939] text-[14px] text-nowrap tracking-[0.07px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Conversation
      </p>
    </div>
  );
...
function MsgPreview() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[4px] grow items-start leading-[1.2] min-h-px min-w-px relative shrink-0 text-[#7a7d7d] text-nowrap" data-name="msg-preview">
      <p className="[white-space-collapse:collapse] font-['Instrument_Sans:SemiBold',sans-serif] font-semibold overflow-ellipsis overflow-hidden relative shrink-0 text-[14px] tracking-[0.07px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Issue with my account
      </p>
      <p className="[white-space-collapse:collapse] font-['Instrument_Sans:Regular',sans-serif] font-normal overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] tracking-[0.06px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function TableRow() {
  return (
    <div className="bg-[#fefefe] relative shrink-0 w-full" data-name="table_row">
...
function TableRow1() {
  return (
    <div className="bg-[#fefefe] content-stretch flex items-center overflow-clip relative shrink-0 w-full" data-name="table_row">
      <div className="flex flex-row items-center self-stretch">
...
function Table() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[936px] z-[1]" data-name="Table">
      <TableHeading />
      <TableRow />
      <TableRow1 />
    </div>
...
export default function Main() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] isolate items-center relative size-full" data-name="Main">
      <Header />
      <Table />
    </div>
  );
